<template>
    <div class="card bg-base-100 shadow h-[500px] flex flex-col">
        <!-- Header -->
        <div class="bg-primary-100 text-primary-700 rounded-t-md p-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    <ChatBubbleBottomCenterTextIcon class="w-5" />
                    <h2 class="text-lg font-semibold">Chat en vivo</h2>
                </div>
                <span class="badge text-xs border-none"
                    :class="chatStarted ? 'bg-green-500 text-white' : 'bg-primary-800'">
        ...
        <div class="flex-1 overflow-hidden bg-white p-4">
            ...
            <div v-if="!chatStarted" class="flex flex-col items-center text-center h-full justify-between">
                <div>
                    ...
                    <h3 class="text-lg font-semibold text-primary-700">Soporte instantáneo</h3>
                    <p class="text-sm text-primary-600 opacity-85 max-w-xs">
                    ...
                    <div class="mt-4 w-full">
                        <div
                            class="flex justify-center items-center gap-2 bg-primary-100 p-2 rounded-lg text-sm text-primary-600">
                ...
                <!-- Botón iniciar -->
                <button class="btn btn-outline bg-green-500 border-none w-full mt-4 text-white hover:bg-green-400"
                    @click="startChat">
            ...
            <div v-else class="flex flex-col h-full">
                ...
                <div class="pb-2 border-b border-primary-500 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-primary-600">Agente de soporte</p>
                ...
                <div ref="chatContainer" class="flex-1 overflow-y-auto py-4 space-y-2">
                    <div v-for="(msg, index) in messages" :key="index" :class="getMessageClass(msg.from)">
                        ...
                        <div class="chat-bubble text-primary-700 text-sm bg-primary-100">{{ msg.text }}</div>
                    </div>
                </div>
