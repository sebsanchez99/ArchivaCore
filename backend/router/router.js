...
const authAppRouter = require('./app/auth.router.js')
const adminAppRouter = require('./app/admin.router.js')
const folderRouter = require('./app/folder.router.js')
const microRouter = require('./app/micro.router.js')
const authWebRouter = require('./web/auth.router.js')
const supabaseWebRouter = require('./web/supabase.router.js')
const adminWebRouter = require('./web/admin.router.js')
const settingsWebRouter = require('./web/settings.router.js')
const notificationRouter = require('./app/notification.router.js')
